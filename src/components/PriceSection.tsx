...
const layers = [
  { label: "Сырьё $1.5–3", desc: "Оптовый порошок из Китая или Индии", color: "bg-success", height: 8 },
  { label: "Упаковка $4–6", desc: "Глянцевая крышка, «крафтовая» коробка", color: "bg-blue-500", height: 12 },
  { label: "Маркетинг $15–25", desc: "Блогеры, таргет, МЛМ-комиссии", color: "bg-warning", height: 30 },
  { label: "Логистика $3–5", desc: "НДС 12%, таможня, налоги", color: "bg-muted-foreground", height: 10 },
...
const PriceSection = () => (
  <section id="price" className="py-20 sm:py-28">
    <div className="section-container">
      ...
      >
        <p>
          Большинство потребителей верят, что платят за редкие экстракты из Гималаев или уникальные морские компоненты. 
          Реальность циничнее.
        </p>
        <p>
          Если ингредиент декларируется не как «сырьё для БАД», а как «пищевая добавка», открывается упрощённая схема ввоза. 
          Именно так тонны белого порошка превращаются в «уникальный натуральный продукт» с наценкой 1000%.{" "}
          <span className="text-foreground font-semibold">Красиво придумано, не правда ли?</span>
        </p>
      </motion.div>
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ delay: 1 }}
            className="bg-card border border-destructive/30 rounded-lg p-6 text-center mb-6"
          >
          ...
          >
            <h4 className="font-heading font-bold text-foreground text-sm mb-2">
              🇨🇳 Китай: фабрика мировых БАДов
            </h4>
            <p className="text-muted-foreground text-sm leading-relaxed">
              Китай производит <strong className="text-foreground">60–70% мирового витаминного сырья</strong>. 
              Дешёвый порошок из провинций Хубэй, Цзянсу и Хэбэй лежит в основе большинства казахстанских, 
              российских и даже американских БАДов. При этом в самом Китае с 2016 года действует обязательная 
              регистрация всех добавок — одна из самых строгих систем в Азии. Казахстан движется в обратном направлении.
            </p>
          </motion.div>
        </div>
      </div>
