...
const layers = [
  ...
  { label: "ИТОГО ~$25–40 → продаётся за $60", desc: "", color: "bg-destructive", height: 15 },
];
...
const PriceSection = () => (
  <section id="price" className="py-20 sm:py-28">
    <div className="section-container">
      ...
      >
        <span className="text-gradient-gold">КАК ИЗ $2 ПОЛУЧАЕТСЯ $60</span>
      </motion.h2>
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col-reverse gap-1 max-w-xs mx-auto w-full">
          {layers.map((layer, i) => (
            ...
            >
              <span className="text-xs sm:text-sm font-semibold text-primary-foreground text-center truncate">
                {layer.label}
              </span>
            </motion.div>
          ))}
        ...
        <div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ delay: 1 }}
            className="bg-card border border-primary/30 rounded-lg p-6 text-center"
          >
            <p className="text-3xl sm:text-4xl font-bold text-primary font-body mb-2">300–1000%</p>
